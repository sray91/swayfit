      ...
      <div className="bg-orange">
        ...
        <main className="flex flex-col flex-1 min-h-screen justify-center items-center p-16 mx-auto">
          ...
          <button onClick={ () => connectWallet("injected")}
            className="h-11 border-0 w-auto px-40 rounded-md cursor-pointer text-base font-bold text-white bg-gradient-to-r from-lime-400 to-sky-800 animate-gradient-x">
            Connect Wallet
          </button>
        </main>
      </div>
